...
class Mapa extends React.Component {
    ...
    /* carregarMapa = () => {
        cidadaoService.getCidadaosByUF().then((resposta) => {
            ...
            this.setState({ cidadaosByUF: resposta, 
               aguardandoDados: false 
            });
    ...
    isEstadoComDoencas = (uf) => {
      for (var i = 0; i < this.state.cidadaosByUF.length; i++) {
         if(this.state.cidadaosByUF[i].uf===uf) {
            return this.state.cidadaosByUF[i].quant_cidadao>0;
         }
      }
    }
    ...
    render() {
        ...
        c-6.208,0-11.257-5.036-11.257-11.262C422.54,138.647,427.589,133.597,433.797,133.597z"
                ...
                {!this.state.aguardandoDados && (
                    <div>
                        {this.state.cidadaosByUF.map((estado, index) => (
                            <Tooltip
                                key={estado.uf}
                                placement="top"
                            ...
                            >
                                {estado.nome}: {estado.quant_cidadao} cidadaos{" "}
                            </Tooltip>
                        ))}
                    </div>
                )}
